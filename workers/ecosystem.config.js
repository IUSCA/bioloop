  ...
  apps: [
    {
      name: "celery_worker",
      script: "python",
      args: "-m celery -A workers.celery_app worker --loglevel INFO -O fair --pidfile celery_worker.pid --hostname 'bioloop-dev-celery-w1@%h' --autoscale=16,4 --queues 'bioloop-dev.sca.iu.edu.q'",
      watch: false,
      interpreter: "",
