...
def generate_metadata(celery_task, source: Path):
    ...
    returns:    number of files, 
                ...
                the md5 digest and relative filenames
    """
    num_files, num_directories, size = 0, 0, 0
    metadata = []
    errors = []
    ...
    return num_files, num_directories, size, metadata
...
def inspect_dataset(celery_task, dataset_id, **kwargs):
    ...
    num_files, num_directories, size, metadata = generate_metadata(celery_task, source)
