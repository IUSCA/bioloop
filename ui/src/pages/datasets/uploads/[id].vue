            ...
            <va-inner-loading :loading="loadingLogs">
              ...
              <div v-else class="text-center py-8">
                ...
                <div class="text-sm mt-2 text-gray-500">
                  The verification task registered its process ID but has not
                  written any log entries yet. This usually resolves within a
                  few seconds — the page refreshes automatically every 10 s.
                </div>
              </div>
            </va-inner-loading>
          </va-card-content>
          ...
          <va-card-content>
            <div class="text-center py-8">
              ...
              <div class="font-medium">
                No verification task logs available for this upload.
              </div>
              <div class="text-sm mt-2 text-gray-500 max-w-lg mx-auto">
                {{ noLogsExplanation }}
              </div>
            </div>
          </va-card-content>
