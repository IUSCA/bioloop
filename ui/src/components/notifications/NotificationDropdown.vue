<template>
  <va-menu placement="left-bottom">
    ...
    <div class="notif-dropdown" data-testid="notification-menu-items">
      ...
      <!-- Empty state -->
      <div v-else-if="recentNotifications.length === 0" class="notif-dropdown-empty">
        <i-mdi-bell-off-outline class="text-3xl mb-1" style="color: var(--va-secondary)" />
        <span class="text-sm" style="color: var(--va-secondary)">No notifications yet</span>
      </div>
