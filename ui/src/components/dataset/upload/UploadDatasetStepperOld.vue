...
<!--    >-->
<!--      &lt;!&ndash; Step icons and labels &ndash;&gt;-->
<!--      <template-->
...
<!--        <va-form-field v-slot="{value: v} v-model=">-->
<!--          <DatasetNameInput-->
<!--            label="Dataset Name"-->
...
<!--        &lt;!&ndash;                  :rules="[&ndash;&gt;-->
<!--        &lt;!&ndash;            (value) => {&ndash;&gt;-->
<!--        &lt;!&ndash;              return (value && value.length > 0) || 'Name is required';&ndash;&gt;-->
<!--        &lt;!&ndash;            },&ndash;&gt;-->
<!--        &lt;!&ndash;            (value) => {&ndash;&gt;-->
<!--        &lt;!&ndash;              return (&ndash;&gt;-->
<!--        &lt;!&ndash;                (value && value.length > 2) ||&ndash;&gt;-->
<!--        &lt;!&ndash;                'Name must be 3 or more characters'&ndash;&gt;-->
<!--        &lt;!&ndash;              );&ndash;&gt;-->
<!--        &lt;!&ndash;            },&ndash;&gt;-->
<!--        &lt;!&ndash;            (value) => {&ndash;&gt;-->
<!--        &lt;!&ndash;              return value.indexOf(' ') === -1 || 'Name cannot contain spaces';&ndash;&gt;-->
<!--        &lt;!&ndash;            },&ndash;&gt;-->
<!--        &lt;!&ndash;            validateNotExists,&ndash;&gt;-->
<!--        &lt;!&ndash;          ]"&ndash;&gt;-->
<!--      </template>-->

<!--      &lt;!&ndash;      <template #step-content-1>&ndash;&gt;-->
<!--      &lt;!&ndash;        <FileTypeSelect&ndash;&gt;-->
<!--      &lt;!&ndash;          v-model="fileType"&ndash;&gt;-->
<!--      &lt;!&ndash;          :file-type-list="fileTypeList"&ndash;&gt;-->
<!--      &lt;!&ndash;          @file-type-created="&ndash;&gt;-->
<!--      &lt;!&ndash;            (newFileType) => {&ndash;&gt;-->
<!--      &lt;!&ndash;              // if a new File Type has already been created, remove it&ndash;&gt;-->
<!--      &lt;!&ndash;              const currentNewFileTypeIndex = fileTypeList.findIndex(&ndash;&gt;-->
<!--      &lt;!&ndash;                (e) => !e.id,&ndash;&gt;-->
<!--      &lt;!&ndash;              );&ndash;&gt;-->
<!--      &lt;!&ndash;              if (currentNewFileTypeIndex) {&ndash;&gt;-->
<!--      &lt;!&ndash;                fileTypeList.splice(currentNewFileTypeIndex, 1);&ndash;&gt;-->
<!--      &lt;!&ndash;              }&ndash;&gt;-->
<!--      &lt;!&ndash;              fileTypeList.push(newFileType);&ndash;&gt;-->
<!--      &lt;!&ndash;            }&ndash;&gt;-->
<!--      &lt;!&ndash;          "&ndash;&gt;-->
<!--      &lt;!&ndash;          :messages="&ndash;&gt;-->
<!--      &lt;!&ndash;            !isFormValid(1, 'FileTypeSelect') ? [stepErrors.fileType] : []&ndash;&gt;-->
<!--      &lt;!&ndash;          "&ndash;&gt;-->
<!--      &lt;!&ndash;          :message-variant="&ndash;&gt;-->
<!--      &lt;!&ndash;            !stepErrors(1, 'FileTypeSelect') ? 'error' : undefined&ndash;&gt;-->
<!--      &lt;!&ndash;          "&ndash;&gt;-->
<!--      &lt;!&ndash;        />&ndash;&gt;-->
...
<!--      &lt;!&ndash;      <template #step-content-1>&ndash;&gt;-->
<!--      &lt;!&ndash;        <va-select&ndash;&gt;-->
<!--      &lt;!&ndash;          name="raw_data"&ndash;&gt;-->
<!--      &lt;!&ndash;          v-model="sourceRawData"&ndash;&gt;-->
<!--      &lt;!&ndash;          v-model:search="rawDataSelected_search"&ndash;&gt;-->
<!--      &lt;!&ndash;          autocomplete&ndash;&gt;-->
<!--      &lt;!&ndash;          class="w-full raw_data_select"&ndash;&gt;-->
<!--      &lt;!&ndash;          label="Source Raw Data"&ndash;&gt;-->
<!--      &lt;!&ndash;          placeholder="Raw Data"&ndash;&gt;-->
<!--      &lt;!&ndash;          :options="rawDataList"&ndash;&gt;-->
<!--      &lt;!&ndash;          :text-by="(option) => option.name"&ndash;&gt;-->
<!--      &lt;!&ndash;          :rules="[&ndash;&gt;-->
<!--      &lt;!&ndash;            (value) => {&ndash;&gt;-->
<!--      &lt;!&ndash;              return (&ndash;&gt;-->
<!--      &lt;!&ndash;                (value && value.name.length > 0) ||&ndash;&gt;-->
<!--      &lt;!&ndash;                'Source Raw Data is required'&ndash;&gt;-->
<!--      &lt;!&ndash;              );&ndash;&gt;-->
<!--      &lt;!&ndash;            },&ndash;&gt;-->
<!--      &lt;!&ndash;          ]"&ndash;&gt;-->
<!--      &lt;!&ndash;        />&ndash;&gt;-->
...
<!--      &lt;!&ndash; File upload tool and selected files table &ndash;&gt;-->
