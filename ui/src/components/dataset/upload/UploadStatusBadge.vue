<template>
  <!-- UPLOADING -->
  <div
    v-if="props.status === constants.UPLOAD_STATUSES.UPLOADING"
  ...
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.UPLOADED"
    class="flex items-center"
  >
  ...
  <!-- VERIFYING -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.VERIFYING"
    class="flex items-center"
  >
  ...
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.VERIFIED"
    class="flex items-center"
  >
  ...
  <div
    v-else-if="props.integratedStatus === 'ACTIVE'"
    class="flex items-center"
  >
  ...
  <div
    v-else-if="props.integratedStatus === 'SUCCESS'"
    class="flex items-center"
  >
  ...
  <div
    v-else-if="props.integratedStatus === 'FAILURE'"
    class="flex items-center"
  >
  ...
  <!-- VERIFICATION_FAILED -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.VERIFICATION_FAILED"
    class="flex items-center"
  >
    <va-popover
      :message="
        props.failureReason
          ? `Verification failed: ${props.failureReason}`
  ...
  <!-- PERMANENTLY_FAILED -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.PERMANENTLY_FAILED"
    class="flex items-center"
  >
    <va-popover
      :message="
        props.failureReason
          ? `Permanently failed: ${props.failureReason}`
  ...
  <!-- PROCESSING_FAILED -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.PROCESSING_FAILED"
    class="flex items-center"
  >
    <va-popover
      :message="
        props.failureReason
          ? `Processing failed: ${props.failureReason}`
          : 'Processing failed'
      "
    >
      <va-icon name="error" color="danger" />
  ...
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.PROCESSING"
    class="flex items-center"
  >
  ...
  <!-- COMPLETE -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.COMPLETE"
    class="flex items-center"
  >
  ...
  <!-- UPLOAD_FAILED -->
  <div
    v-else-if="props.status === constants.UPLOAD_STATUSES.UPLOAD_FAILED"
    class="flex items-center"
  >
    <va-popover
      :message="
        props.failureReason
          ? `Upload failed: ${props.failureReason}`
          : 'Upload failed'
      "
    >
      <va-icon name="error" color="danger" />
