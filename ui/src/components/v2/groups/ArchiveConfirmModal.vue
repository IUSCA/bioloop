      ...
      <div>
        <p class="text-sm text-gray-700 dark:text-gray-300">
          <template v-if="props.unarchive">
            ...
            <span class="font-semibold"> {{ props.groupName }} </span>? The
            group will become active again.
          </template>
          <template v-else>
            Are you sure you want to <strong>archive</strong>
            <span class="font-semibold"> {{ props.groupName }} </span>?

            <ul class="list-disc px-3 mt-2 mb-2">
              <li>The group will be closed for updates.</li>
              <li>
                Changes cannot be made to datasets or collections owned by this
                group.
              </li>
              <li>This action can be reversed by a platform admin.</li>
            </ul>
          </template>
        </p>
      </div>
