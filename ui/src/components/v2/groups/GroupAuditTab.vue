...
// Provide context to child components so they can conditionally render group details based on whether we're in a
// group context. When viewing within a group context, the group name becomes redundant and should be hidden.
