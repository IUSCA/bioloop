    ...
    <VaCardContent>
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p
            class="text-xs font-medium uppercase tracking-wide text-center"
          ...
          <p
            v-else
            class="text-2xl font-semibold leading-none mt-1 text-center"
          >
            {{
              props.value !== null ? number_formatter.format(props.value) : "—"
            }}
          </p>
        </div>
      </div>
