...
queue_usernmae = os.environ['QUEUE_USER']
queue_password = os.environ['QUEUE_PASS']
mongo_url = os.environ['MONGO_URL']
mongo_usernmae = os.environ['MONGO_USER']
...
broker_url = f'amqp://{queue_usernmae}:{urllib.parse.quote(queue_password)}@{queue_url}'
# task_routes = {
...
result_backend = f'mongodb://{mongo_usernmae}:{urllib.parse.quote(mongo_password)}@{mongo_url}'
