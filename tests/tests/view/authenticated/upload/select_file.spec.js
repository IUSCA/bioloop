...
test.describe('Dataset Upload Process', () => {
  ...
  test('should navigate to upload page and open file selection dialog', async ({ page }) => {
    ...
    // Wait for the file chooser to appear and resolve the promise
    // const fileChooser = await fileChooserPromise;

    // Verify that the file chooser appeared
    // expect(fileChooser).toBeTruthy();

    // Verify that the file upload table is visible after file selection
    // Note: You might need to adjust this selector based on the actual testid
    // in the new upload page
    // await
    // expect(page.locator('[data-testid="file-upload-table"]')).toBeVisible();
  });
});
