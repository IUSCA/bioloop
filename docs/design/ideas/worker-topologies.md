...
Illustrative deployment shapes for the Celery workers. **None of these is the topology Bioloop actually runs.** For the deployed setup see [Workers](/reference/workers/overview.md).
:::
