...
**Nobody has committed to building this.** It proposes allow/deny rules evaluated per file, on top of the dataset- and collection-level grants that actually exist. There is no `file_access_rule` model or equivalent in the codebase.
:::
