...
**Nobody has committed to building this.** It proposes pushing datasets to user-owned HPFS directories, cloud buckets, and Globus endpoints. No push or Globus code exists in `api/` or `workers/`.
:::
