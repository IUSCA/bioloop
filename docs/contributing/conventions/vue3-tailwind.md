...
- **Use Vuestic UI components** for common UI patterns instead of building custom replacements. See [Vuestic Docs](https://vuestic.dev/) and [UI Coding Standards](/contributing/ui-coding-standards) for component usage.
  ```vue
