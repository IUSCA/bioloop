...
Because this is a large change set, the implementation is organized so reviewers can follow it in layers:
...
- Documentation
  ...
  - Added notifications design document in `docs/features/notifications.md`.
