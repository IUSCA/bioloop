...
CREATE TABLE "dataset_share" (
    ...
    "globus_share_id" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "dataset_share" ADD CONSTRAINT "dataset_share_globus_share_id_fkey" FOREIGN KEY ("globus_share_id") REFERENCES "globus_share"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
