...
-- CreateIndex
CREATE INDEX "grant_subject_type_subject_id_idx" ON "grant"("subject_type", "subject_id");

-- CreateIndex
CREATE INDEX "grant_resource_type_resource_id_idx" ON "grant"("resource_type", "resource_id");
...
-- CreateIndex
CREATE INDEX "access_request_resource_type_resource_id_status_idx" ON "access_request"("resource_type", "resource_id", "status");
...
-- AddForeignKey
ALTER TABLE "grant" ADD CONSTRAINT "dataset_resource_id" FOREIGN KEY ("resource_id") REFERENCES "dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "grant" ADD CONSTRAINT "collection_resource_id" FOREIGN KEY ("resource_id") REFERENCES "collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "access_request" ADD CONSTRAINT "dataset_resource_id" FOREIGN KEY ("resource_id") REFERENCES "dataset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "access_request" ADD CONSTRAINT "collection_resource_id" FOREIGN KEY ("resource_id") REFERENCES "collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
