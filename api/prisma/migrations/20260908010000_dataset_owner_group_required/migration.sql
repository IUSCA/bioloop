...
--
-- Unlike the "Everyone" principal, this is a real group: it owns datasets, takes part in
...
VALUES ('00000000-0000-4000-8000-000000000001', 'GROUP')
...
VALUES ('00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001', 0)
...
CREATE OR REPLACE RULE prevent_unassigned_datasets_delete AS
  ON DELETE TO "group"
  WHERE OLD.id = '00000000-0000-4000-8000-000000000001'
  DO INSTEAD NOTHING;
