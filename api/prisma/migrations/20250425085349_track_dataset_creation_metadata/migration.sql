...
-- AlterTable
ALTER TABLE "dataset" ADD COLUMN     "src_instrument_id" INTEGER;
...
-- AddForeignKey
ALTER TABLE "dataset" ADD CONSTRAINT "dataset_src_instrument_id_fkey" FOREIGN KEY ("src_instrument_id") REFERENCES "instrument"("id") ON DELETE SET NULL ON UPDATE CASCADE;
