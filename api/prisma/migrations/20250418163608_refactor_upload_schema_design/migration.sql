...
-- AddForeignKey
ALTER TABLE "dataset_create_log" ADD CONSTRAINT "dataset_create_log_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dataset_create_log" ADD CONSTRAINT "dataset_create_log_instrument_id_fkey" FOREIGN KEY ("instrument_id") REFERENCES "instrument"("id") ON DELETE SET NULL ON UPDATE CASCADE;
