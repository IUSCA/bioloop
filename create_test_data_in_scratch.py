#!/usr/bin/env python3
"""
Script to create test data in the proper scratch directory location
"""
...
def create_test_case_01():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_01_basic_registration/data")
...
def create_test_case_02():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_02_renaming_with_prefix_suffix/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_03():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_03_hard_linking/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_04():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_04_idempotency/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_05():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_05_large_dataset/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_06():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_06_mixed_content/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_07():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_07_error_handling/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def create_test_case_08():
    ...
    base_path = Path("/opt/sca/data/scratch/test_rename_and_register/test_08_cleanup/data")
    base_path.mkdir(parents=True, exist_ok=True)
...
def main():
    ...
    print("Creating test data for all test cases in /opt/sca/data/scratch/test_rename_and_register/...")
    ...
    print("Test directories are available at /opt/sca/data/scratch/test_rename_and_register/test_*")
